# TwiXXX OSS Privacy Build

This is the APK-decoded source-equivalent package for the TwiXXX OSS privacy build.
...
The matching release keystore is provided separately as `twixxx-oss-release.keystore`.
